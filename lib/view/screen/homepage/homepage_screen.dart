                          ...
                          child: NotificationListener<OverscrollIndicatorNotification>(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index){
                                  return InkWell(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => ProductScreen(newProductsModel: newProduct.newProductList[index],)));
                                    },
                                    child: Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Text(popularApi.popularApiList![index].title,style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeLarge,color: ColorResources.textFontColor),textAlign: TextAlign.center,),

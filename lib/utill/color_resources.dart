...
class ColorResources {
  ...
  static const Color gainsBoro = Color(0xffE6E6E6);
  ...
  static const Color sellerTXT = Color(0xff92C6FF);
  ...
  // ------------->>>> App Color Source <<<<-----------------
  static const Color splashBorder = Color(0xffffcd29);
  static const Color flateColor = Color(0xfffc9803);
  static const Color backGroundColor = Color(0xfff8f8f9);
  static const Color searchBackGroundColor = Color(0xffe5e5e5); //--->> Home Screen
  static const Color textFontColor = Color(0xff646e77); // -->> Home Screen ListView Text Color
  static const Color underLine = Color(0xffe9edf0); //---->> Home Screen Container UnderLine Color
  static const Color hindSearch = Color(0xff585858); // --->> Search Screen TextField Find Color
  static const Color searchLogo = Color(0xff646e77); // --->> Search Screen Search Logo Color
  static const Color gridFindBackColor = Color(0xffe4f9eb); // --->> Find Screen Gridview BackGround Color
  static const Color underLineFind = Color(0xffc4c4c4); // --->> Find Screen Container Color
  static const Color textColorFind = Color(0xfffc9803); // --->> Find Screen Button Text Color
  static const Color iconNextFavourite = Color(0xfffc9803); // --->> Favourite Screen Button Color
  static const Color textCart = Color(0xff223263); // --->> Favourite Screen Button Color
  ...
  static const MaterialColor primatyMaterial = MaterialColor(0xFF192D6B, colorMap);
}
